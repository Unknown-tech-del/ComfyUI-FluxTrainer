...
from .nodes_zimage import NODE_CLASS_MAPPINGS as NODE_CLASS_MAPPINGS_ZIMAGE
from .nodes_zimage import NODE_DISPLAY_NAME_MAPPINGS as NODE_DISPLAY_NAME_MAPPINGS_ZIMAGE
